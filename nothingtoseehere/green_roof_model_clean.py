...
# ==============================================================================
# FILE MAP — CARA MEMBACA MODUL INI
# ==============================================================================
# 01. Struktur parameter        : dataclass untuk tanaman, substrat, slab, geometri, numerik
# 02. Nilai default             : nilai awal CAM/C3, substrat, slab, geometri
# 03. Konfigurasi validasi      : window tanggal, target sensor, helper update parameter
# 04. Data loaders              : Davis/weather, NI LabVIEW, LI-6800, RIKA soil moisture
# 05. Pre-processing            : sinkronisasi dan resampling data
# 06. Helper termodinamika      : psikrometri, radiasi langit, konveksi indoor
# 07. Foliage model             : resistansi aerodinamis/stomata dan temperatur daun
# 08. Substrate model           : properti termal, panas, dan kelembaban substrat
# 09. Slab model                : konduksi slab + boundary indoor
# 10. Simulation loop           : loop utama simulasi green roof
# 11. Validasi dan kalibrasi    : metrics, LAI calibration, run_validation_case
# 12. Visualisasi               : plotting hasil simulasi
# 13. Contoh pemakaian          : hanya jalan kalau file ini dieksekusi langsung
# ==============================================================================
...
# ==============================================================================
# 01 — STRUKTUR PARAMETER / DATA CLASSES
# ==============================================================================
...
wedelia = PlantParameters(
    ...
    LAI         = 0.69,     # [REAL] dari data setahun lalu — akan dikalibrasi
    ...
    cover_fraction = 0.45   # projected canopy cover fraction, 0-1
)
...
# ==============================================================================
# 03 — KONFIGURASI VALIDASI DAN HELPER PARAMETER
# ==============================================================================
# Data CAM dan C3 boleh berasal dari window tanggal yang berbeda.
# Target sensor bisa diganti dari runner lewat VALIDATION_TARGETS.
# ==============================================================================
...
# ==============================================================================
# 05 — PRE-PROCESSING DAN RESAMPLING
# ==============================================================================
...
def run_validation_case(plant_type: str,
    ...
    # Pilih sensor indoor dan target validasi berdasarkan tipe tanaman.
    if plant_type == 'CAM':
