...
bromelia = PlantParameters(
    ...
    LAI         = 2.4,     # [REAL] dari data setahun lalu — akan dikalibrasi
...
wedelia = PlantParameters(
    ...
    LAI         = 0.7,     # [REAL] dari data setahun lalu — akan dikalibrasi
...
substrat = SubstrateParameters(
    ...
    lambda_dry  = 0.08,    # [LIT/EST] W/mK — tanah+sekam padi ringan, dry
    ...
    theta_sat   = 0.55,    # [EST] m³/m³ — scientific guess awal, update dari RIKA/literatur
...
def apply_scientific_guess_parameters(
    rho_g: float = 400.0,
    theta_sat: float = 0.85,
    k_theta_sat: float = 5e-6,
    H_g: float = 0.1,
    H_slab: float = 0.10,
    lambda_dry: float = 0.08,
...
def prepare_validation_case(plant_type: str,
    ...
    ni_files = [
        ...
        str(base / 'NI_sensor_data_clean.xlsx'),
    ]
