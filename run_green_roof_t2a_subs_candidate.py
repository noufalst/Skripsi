...
import new_baru_revised_same_structure_v3_t2a_subs_candidate as gr
...
BASE_DIR = SCRIPT_DIR
OUTPUT_DIR = SCRIPT_DIR / "outputs_t2a_subs_candidate"
...
CAM_TARGET = "T2A2"   # main CAM inner-roof validation target; T2A is treated as lower/wet substrate candidate
