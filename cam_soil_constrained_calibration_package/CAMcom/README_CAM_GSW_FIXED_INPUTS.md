...
## v7 update — slab node export

This version exports additional slab temperature nodes in both prediction CSV files:
...
T_s_mid : middle slab node
T_s_in  : bottom/inside slab surface / "atap indoor"
```

This is needed for stack-aware validation:
...
Run the CAM model again, then rerun:
