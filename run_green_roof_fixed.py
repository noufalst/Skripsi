...
import new_baru_revised_same_structure_v3_fixed as gr


# =============================================================================
# USER CONFIG
# =============================================================================
BASE_DIR = Path(".")              # folder containing weatherfile, NI xlsx, datasoilmoisture.zip
OUTPUT_DIR = Path("outputs")
OUTPUT_DIR.mkdir(exist_ok=True)

RUN_CAM = False                   # set True only when CAM window/file choices are ready
RUN_C3_MAIN = True
...
gr.VALIDATION_TARGETS["CAM"] = "T2A2"   # change to "T1Tb" if your CAM target is inner roof sensor T1Tb
gr.VALIDATION_TARGETS["C3"] = "T3Ka"    # atap indoor C3
...
def main():
    ...
    if RUN_CAM:
        outputs["CAM"] = run_one_case("CAM", "CAM_main")
